# weak-password-policy.ps1
# Phase 1 – Intentionally broken domain password policy
# Run on DC01 as Domain Admin

Import-Module ActiveDirectory

# Create a new Fine-Grained Password Policy (PSO) that's deliberately terrible
...
# Also apply to regular users so the whole domain feels "real"
